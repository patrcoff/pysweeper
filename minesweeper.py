...
#ORIGINAL PROTOTYPING, HIT A WALL WITH USE OF BUTTONS IN TK NOT HAVING A MECHANISM TO DETECT MOUSEBUTTON
#HENCE MOVED TO PYGAME VERSION - MINEPYGAME.PY
#NOT DELETING TO SHOW EVOLUTION OF PROJECT
